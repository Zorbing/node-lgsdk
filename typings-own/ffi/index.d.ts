...
declare module "ffi" {
	...
	// type FFI_TYPE_NAME = 'void' | 'uint8' | 'int8' | 'uint16' | 'int16' | 'uint32' | 'int32' | 'uint64' | 'int64' | 'uchar' | 'char' | 'ushort' | 'short' | 'uint' | 'int' | 'float' | 'double' | 'pointer' | 'ulonglong' | 'longlong';
    ...
    export var FFI_TYPES: {
		void: Buffer;
		pointer: Buffer;
		char: Buffer;		uchar: Buffer;
		short: Buffer;		ushort: Buffer;
		int: Buffer;		uint: Buffer;
		int8: Buffer;		uint8: Buffer;
		int16: Buffer;		uint16: Buffer;
		int32: Buffer;		uint32: Buffer;
		int64: Buffer;		uint64: Buffer;
		longlong: Buffer;	ulonglong: Buffer;
    ...
    export var types: {
		...
		byte: ref.Type;
		bool: ref.Type;
		char: ref.Type;			uchar: ref.Type;
		short: ref.Type;		ushort: ref.Type;
        int: ref.Type;			uint: ref.Type;
        int8: ref.Type;			uint8: ref.Type;
        int16: ref.Type;		uint16: ref.Type;
        int32: ref.Type;		uint32: ref.Type;
		int64: ref.Type;		uint64: ref.Type;
		long: ref.Type;			ulong: ref.Type;
		longlong: ref.Type;		ulonglong: ref.Type;
		double: ref.Type;		float: ref.Type;
		Object: ref.Type;
		CString: ref.Type;
		size_t: ref.Type;
    };
